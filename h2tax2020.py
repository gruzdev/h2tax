...
def main():
    ...
    fill_div("2020-04-08", 16.21, 1.62, desc)
    # ...
    fill_div("2020-12-31", 42.05, 4.20, desc)

    # Ввод данных о процентах на остаток денежных средств.
    fill_interest("2020-01-31", 0.89)
    # ...
    fill_interest("2020-12-31", 0.98)

    # Ввод данных о доходах от реализации ЦБ:
    fill_stocksell("2020-12-31", 5815, 374099.18, "1234AA-5678BB")
